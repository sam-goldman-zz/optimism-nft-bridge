...
export interface ChugSplashDictatorInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "bridgeSlotKey", values?: undefined): string;
    encodeFunctionData(functionFragment: "bridgeSlotVal", values?: undefined): string;
    encodeFunctionData(functionFragment: "codeHash", values?: undefined): string;
    encodeFunctionData(functionFragment: "doActions", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "finalOwner", values?: undefined): string;
    encodeFunctionData(functionFragment: "isUpgrading", values?: undefined): string;
    encodeFunctionData(functionFragment: "messengerSlotKey", values?: undefined): string;
    encodeFunctionData(functionFragment: "messengerSlotVal", values?: undefined): string;
    encodeFunctionData(functionFragment: "returnOwnership", values?: undefined): string;
    encodeFunctionData(functionFragment: "target", values?: undefined): string;
    decodeFunctionResult(functionFragment: "bridgeSlotKey", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "bridgeSlotVal", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "isUpgrading", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "messengerSlotKey", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "messengerSlotVal", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "returnOwnership", data: BytesLike): Result;
...
export interface ChugSplashDictator extends BaseContract {
    ...
    functions: {
        ...
        doActions(_code: BytesLike, overrides?: Overrides & {
        ...
        returnOwnership(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
