...
export interface L1ChugSplashProxyInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "setStorage", values: [BytesLike, BytesLike]): string;
...
export interface L1ChugSplashProxy extends BaseContract {
    ...
    functions: {
        ...
        getOwner(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setCode(_code: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setOwner(_owner: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setStorage(_key: BytesLike, _value: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    getImplementation(overrides?: Overrides & {
    ...
    callStatic: {
        ...
        setStorage(_key: BytesLike, _value: BytesLike, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
        getImplementation(overrides?: Overrides & {
