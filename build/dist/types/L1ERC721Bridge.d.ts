...
export interface L1ERC721BridgeInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "deposits", values: [string, string, BigNumberish]): string;
...
export interface L1ERC721Bridge extends BaseContract {
    ...
    functions: {
        ...
        deposits(arg0: string, arg1: string, arg2: BigNumberish, overrides?: CallOverrides): Promise<[boolean]>;
        ...
        initialize(_l1messenger: string, _l2ERC721Bridge: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        initialize(_l1messenger: string, _l2ERC721Bridge: string, overrides?: CallOverrides): Promise<void>;
        l2ERC721Bridge(overrides?: CallOverrides): Promise<string>;
        messenger(overrides?: CallOverrides): Promise<string>;
        onERC721Received(operator: string, from: string, tokenId: BigNumberish, data: BytesLike, overrides?: CallOverrides): Promise<string>;
    };
    ...
    estimateGas: {
        ...
        deposits(arg0: string, arg1: string, arg2: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        finalizeERC721Withdrawal(_l1Token: string, _l2Token: string, _from: string, _to: string, _tokenId: BigNumberish, _data: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<BigNumber>;
        initialize(_l1messenger: string, _l2ERC721Bridge: string, overrides?: Overrides & {
        ...
        onERC721Received(operator: string, from: string, tokenId: BigNumberish, data: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        depositERC721(_l1Token: string, _l2Token: string, _tokenId: BigNumberish, _l2Gas: BigNumberish, _data: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        ...
        deposits(arg0: string, arg1: string, arg2: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        finalizeERC721Withdrawal(_l1Token: string, _l2Token: string, _from: string, _to: string, _tokenId: BigNumberish, _data: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<PopulatedTransaction>;
        initialize(_l1messenger: string, _l2ERC721Bridge: string, overrides?: Overrides & {
        ...
        onERC721Received(operator: string, from: string, tokenId: BigNumberish, data: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
