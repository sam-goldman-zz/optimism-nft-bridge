...
export interface OVMGasPriceOracleInterface extends utils.Interface {
    functions: {
...
export declare type DecimalsUpdatedEvent = TypedEvent<[BigNumber], {
    arg0: BigNumber;
}>;
export declare type DecimalsUpdatedEventFilter = TypedEventFilter<DecimalsUpdatedEvent>;
export declare type GasPriceUpdatedEvent = TypedEvent<[BigNumber], {
    arg0: BigNumber;
}>;
export declare type GasPriceUpdatedEventFilter = TypedEventFilter<GasPriceUpdatedEvent>;
export declare type L1BaseFeeUpdatedEvent = TypedEvent<[
    BigNumber
], {
    arg0: BigNumber;
}>;
export declare type L1BaseFeeUpdatedEventFilter = TypedEventFilter<L1BaseFeeUpdatedEvent>;
export declare type OverheadUpdatedEvent = TypedEvent<[BigNumber], {
    arg0: BigNumber;
}>;
export declare type OverheadUpdatedEventFilter = TypedEventFilter<OverheadUpdatedEvent>;
...
export declare type ScalarUpdatedEvent = TypedEvent<[BigNumber], {
    arg0: BigNumber;
}>;
export declare type ScalarUpdatedEventFilter = TypedEventFilter<ScalarUpdatedEvent>;
