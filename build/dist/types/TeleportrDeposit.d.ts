...
export interface TeleportrDepositInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "maxDepositAmount", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "setMaxBalance", values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "setMaxBalance", data: BytesLike): Result;
...
export declare type MaxBalanceSetEvent = TypedEvent<[
    BigNumber,
    BigNumber
], {
...
export declare type MaxBalanceSetEventFilter = TypedEventFilter<MaxBalanceSetEvent>;
export declare type MaxDepositAmountSetEvent = TypedEvent<[
    BigNumber,
    BigNumber
], {
...
export declare type MaxDepositAmountSetEventFilter = TypedEventFilter<MaxDepositAmountSetEvent>;
export declare type MinDepositAmountSetEvent = TypedEvent<[
    BigNumber,
    BigNumber
], {
    previousAmount: BigNumber;
...
export declare type MinDepositAmountSetEventFilter = TypedEventFilter<MinDepositAmountSetEvent>;
...
export interface TeleportrDeposit extends BaseContract {
    ...
    functions: {
        ...
        setMaxAmount(_maxDepositAmount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setMaxBalance(_maxBalance: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setMinAmount(_minDepositAmount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        setMaxAmount(_maxDepositAmount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        setMaxBalance(_maxBalance: BigNumberish, overrides?: CallOverrides): Promise<void>;
        setMinAmount(_minDepositAmount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        totalDeposits(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    filters: {
        ...
        "EtherReceived(uint256,address,uint256)"(depositId?: BigNumberish | null, emitter?: string | null, amount?: BigNumberish | null): EtherReceivedEventFilter;
        EtherReceived(depositId?: BigNumberish | null, emitter?: string | null, amount?: BigNumberish | null): EtherReceivedEventFilter;
        "MaxBalanceSet(uint256,uint256)"(previousBalance?: null, newBalance?: null): MaxBalanceSetEventFilter;
        MaxBalanceSet(previousBalance?: null, newBalance?: null): MaxBalanceSetEventFilter;
        "MaxDepositAmountSet(uint256,uint256)"(previousAmount?: null, newAmount?: null): MaxDepositAmountSetEventFilter;
        MaxDepositAmountSet(previousAmount?: null, newAmount?: null): MaxDepositAmountSetEventFilter;
        "MinDepositAmountSet(uint256,uint256)"(previousAmount?: null, newAmount?: null): MinDepositAmountSetEventFilter;
        MinDepositAmountSet(previousAmount?: null, newAmount?: null): MinDepositAmountSetEventFilter;
