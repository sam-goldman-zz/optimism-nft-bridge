...
export interface TestLibBytes32UtilsInterface extends utils.Interface {
    functions: {
    ...
    encodeFunctionData(functionFragment: "toAddress", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "toBool", values: [BytesLike]): string;
    decodeFunctionResult(functionFragment: "fromAddress", data: BytesLike): Result;
...
export interface TestLibBytes32Utils extends BaseContract {
    ...
    populateTransaction: {
        fromAddress(_in: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        fromBool(_in: boolean, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        toAddress(_in: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        toBool(_in: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
