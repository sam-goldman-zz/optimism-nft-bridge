...
export interface TestLibRLPWriterInterface extends utils.Interface {
    functions: {
    ...
    encodeFunctionData(functionFragment: "writeAddress", values: [string]): string;
    encodeFunctionData(functionFragment: "writeAddressWithTaintedMemory", values: [string]): string;
    encodeFunctionData(functionFragment: "writeBool", values: [boolean]): string;
    encodeFunctionData(functionFragment: "writeBytes", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "writeList", values: [BytesLike[]]): string;
    encodeFunctionData(functionFragment: "writeString", values: [string]): string;
    encodeFunctionData(functionFragment: "writeUint", values: [BigNumberish]): string;
    decodeFunctionResult(functionFragment: "writeAddress", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "writeAddressWithTaintedMemory", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "writeString", data: BytesLike): Result;
...
export interface TestLibRLPWriter extends BaseContract {
    ...
    functions: {
        ...
        writeAddressWithTaintedMemory(_in: string, overrides?: Overrides & {
    ...
    callStatic: {
        writeAddress(_in: string, overrides?: CallOverrides): Promise<string>;
        writeAddressWithTaintedMemory(_in: string, overrides?: CallOverrides): Promise<string>;
        writeBool(_in: boolean, overrides?: CallOverrides): Promise<string>;
        writeBytes(_in: BytesLike, overrides?: CallOverrides): Promise<string>;
        writeList(_in: BytesLike[], overrides?: CallOverrides): Promise<string>;
        writeString(_in: string, overrides?: CallOverrides): Promise<string>;
    ...
    populateTransaction: {
        writeAddress(_in: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        writeAddressWithTaintedMemory(_in: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<PopulatedTransaction>;
        writeBool(_in: boolean, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        writeBytes(_in: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        writeList(_in: BytesLike[], overrides?: CallOverrides): Promise<PopulatedTransaction>;
        writeString(_in: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        writeUint(_in: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
