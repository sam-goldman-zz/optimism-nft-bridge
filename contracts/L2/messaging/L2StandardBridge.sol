 ...
 * enable ETH, ERC20, and ERC721 transitions between L1 and L2.
 * This contract acts as a minter for new tokens when it hears about deposits into the L1 Standard
 * bridge.
 * This contract also acts as a burner of the tokens intended for withdrawal, informing the L1
 * bridge to release L1 funds.
 */
contract L2StandardBridge is IL2ERC20Bridge, IL2ERC721Bridge, CrossDomainEnabled {
    /********************************
    ...
    function withdrawERC20(
        ...
        _initiateERC20Withdrawal(_l2Token, msg.sender, msg.sender, _amount, _l1Gas, _data);
    }
    ...
    function withdrawERC20To(
        ...
        _initiateERC20Withdrawal(_l2Token, msg.sender, _to, _amount, _l1Gas, _data);
    }
    ...
    function _initiateERC20Withdrawal(
        ...
        // slither-disable-next-line reentrancy-events
        emit ERC20WithdrawalInitiated(l1Token, _l2Token, msg.sender, _to, _amount, _data);
    }
