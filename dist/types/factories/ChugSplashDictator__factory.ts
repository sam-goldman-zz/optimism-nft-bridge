...
export class ChugSplashDictator__factory extends ContractFactory {
  ...
  deploy(
    ...
    _finalOwner: string,
    _codeHash: BytesLike,
    _messengerSlotKey: BytesLike,
    _messengerSlotVal: BytesLike,
    _bridgeSlotKey: BytesLike,
    _bridgeSlotVal: BytesLike,
  ...
  attach(address: string): ChugSplashDictator {
    return super.attach(address) as ChugSplashDictator;
  }
  connect(signer: Signer): ChugSplashDictator__factory {
