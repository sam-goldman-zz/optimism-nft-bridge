...
import type {
  ...
  OVMDeployerWhitelistInterface,
} from "../OVMDeployerWhitelist";
...
type OVMDeployerWhitelistConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: OVMDeployerWhitelistConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class OVMDeployerWhitelist__factory extends ContractFactory {
  constructor(...args: OVMDeployerWhitelistConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  connect(signer: Signer): OVMDeployerWhitelist__factory {
    return super.connect(signer) as OVMDeployerWhitelist__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): OVMDeployerWhitelistInterface {
    return new utils.Interface(_abi) as OVMDeployerWhitelistInterface;
  }
  static connect(
    address: string,
