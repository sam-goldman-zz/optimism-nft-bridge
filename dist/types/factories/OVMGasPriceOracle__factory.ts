...
type OVMGasPriceOracleConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: OVMGasPriceOracleConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class OVMGasPriceOracle__factory extends ContractFactory {
  constructor(...args: OVMGasPriceOracleConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): Promise<OVMGasPriceOracle> {
    return super.deploy(_owner, overrides || {}) as Promise<OVMGasPriceOracle>;
  }
  ...
  attach(address: string): OVMGasPriceOracle {
    return super.attach(address) as OVMGasPriceOracle;
  }
  connect(signer: Signer): OVMGasPriceOracle__factory {
    return super.connect(signer) as OVMGasPriceOracle__factory;
  }
