...
describe('L2StandardERC721Factory', () => {
  ...
  beforeEach(async () => {
    ...
    baseURI = ''.concat('ethereum:', L1ERC721.address.toLowerCase(), '@42/tokenURI?uint256=')
  })
  ...
  it('should be able to create a standard ERC721 contract', async () => {
    ...
    expect(await L2StandardERC721Factory.standardERC721Mapping(L1ERC721.address)).to.equal(l2ERC721Address)
  })
